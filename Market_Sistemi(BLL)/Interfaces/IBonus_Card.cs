...
namespace Market.Interfaces
{
    public interface IBonus_Card
    {
        ...
        public Task<ICollection<Bonus_CardGetDto>> DeleteBonus_CardAsync(int Barkod);

        public Task<ICollection<Bonus_CardGetDto>> CreateBonus_CardReportAsync(Bonus_Card_ReportPostDto dto);

        public Task<Bonus_Card_ReportGetDto> DeleteBonus_Card_ReportAsync(Bonus_Card_ReportDeleteDto dto);
